...
@section('content')
    ...
    <div class="max-w-2xl mx-auto px-4 sm:px-6">
        ...
        <div class="mb-6 text-left">
            ...
            <p class="text-sm text-gray-600">Completa los datos para crear un nuevo producto</p>
        </div>
                ...
                <form method="POST" action="{{ route('products.store') }}" enctype="multipart/form-data" class="space-y-5">
                    ...
                    <div>
                        ...
                        <textarea name="description" id="description" rows="3"
                            ...
                            style="border-color: #d1d5db; color: #262020;" placeholder="Describe las características del producto">{{ old('description') }}</textarea>
                        @error('description')
                            <p class="text-red-600 text-xs mt-1 flex items-center">
                                <i class="fas fa-exclamation-circle mr-1 text-xs"></i>
                                {{ $message }}
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="flex items-center pt-6">
                            <label class="flex items-center cursor-pointer">
                                <input type="checkbox" name="available" id="available" value="1" @checked(old('available'))
