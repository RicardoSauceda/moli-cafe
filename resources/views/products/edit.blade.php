  ...
  <div class="card">
    <form method="POST" action="{{ route('products.update', $product) }}" enctype="multipart/form-data">
      ...
      <div class="form-field">
        ...
        <input class="input" id="product_name" type="text" name="product_name" value="{{ old('product_name', $product->product_name) }}" required>
      </div>
      <div class="form-field">
        <label class="label" for="description">Descripción</label>
        <textarea class="textarea" id="description" name="description" rows="3">{{ old('description', $product->description) }}</textarea>
      </div>
      <div class="form-field">
        <label class="label" for="price">Precio</label>
        <input class="input" id="price" type="number" name="price" value="{{ old('price', $product->price) }}" min="0" step="0.01" required>
      </div>
      <div class="form-field">
      ...
      <div class="form-field">
        <label class="checkbox" for="available">
          <input id="available" type="checkbox" name="available" value="1" @checked(old('available', $product->available))>
