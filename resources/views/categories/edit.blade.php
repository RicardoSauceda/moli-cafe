...
@section('title', 'Editar Categoría | MoLi Café')
...
@section('content')
  ...
  <h1 class="mb-4 text-xl sm:text-2xl font-extrabold text-gray-900">Editar Categoría</h1>
  ...
  <div class="rounded-2xl border border-gray-200 bg-white shadow-sm p-4">
    <form method="POST" action="{{ route('categories.update', $category) }}">
      ...
      <div>
        <button type="submit" class="inline-flex items-center rounded-xl bg-moli-yellow text-moli-black font-bold px-4 py-2 border border-yellow-300 shadow-sm hover:brightness-95 focus:outline-none focus:ring-4 focus:ring-yellow-300/50">Actualizar</button>
      </div>
    </form>
  </div>
@endsection
